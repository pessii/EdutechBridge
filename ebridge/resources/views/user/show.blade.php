        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <!-- CSSの実装　URL　https://tailblocks.cc/ -->
                        ...
                        <div class="md:w-1/2">
                            ...
                            <div class="swiper-container">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        @if($product->imageFiveth->filename !== null)
                                            <img src="{{ asset('storage/products/' . $product->imageFiveth->filename )}}">
                                        @else
                                            <img src="">
                                        @endif
                                    </div>
                                    <div class="swiper-slide">
                                        @if($product->imageSix->filename !== null)
                    ...
                    <div class="mb-4 text-center">
                        <button type="button" data-micromodal-trigger="modal-1" href='javascript:;' class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">ショップの詳細</button>
                    </div>
